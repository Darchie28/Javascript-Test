For the Calcualor.js file, the expected value for the 'Subtraction Test' was inccorrect. I changed it to "console.log("Subtraction Test 1:", subtract(10, 4) === 6 ? "Pass" : "False");"
